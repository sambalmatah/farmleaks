<?php 
    ...
    // ambil data
    $kodestu = $_GET["stukode"];

    // buat query
    $query = "SELECT * FROM stuff
                WHERE stukode = '$kodestu'";
...
<body>
    ...
    <form action="" method="post">
        <div>
            ...
            <input type="text" id="kodestu" name="kodestu" value="<?php echo $stuff["stukode"]; ?>" required readonly>
        </div>
        <div>
            <label for="namastu">Nama : </label>
            <input type="text" id="namastu" name="namastu" value="<?php echo $stuff["stunama"]; ?>" required>
        </div>
        <div>
            ...
            <select name="kategoristu" id="kategoristu" required>
                ...
                <option value="<?php echo $category["catkode"]; ?>" cat-nama="<?php echo $category["catnama"]; ?>" <?php if( $category["catkode"] == $stuff["stukategori"] ) echo "selected";?>>
                    <?php echo $category["catkode"]; ?> - <?php echo $category["catnama"]; ?>
                </option>
                <?php endforeach; ?>
            </select>
        </div>
        <div>
            ...
            <input type="text" id="kategorinamastu" name="kategorinamastu" value="<?php echo $stuff["stukategorinama"]; ?>" required readonly>
        </div>
        <div>
            ...
            <select name="unitstu" id="unitstu" required>
                ...
                <option value="<?php echo $denomination["denkode"]; ?>" den-nama="<?php echo $denomination["dennama"]; ?>" <?php if( $denomination["denkode"] == $stuff["stuunit"] ) echo "selected"; ?>>
                    <?php echo $denomination["denkode"]; ?> - <?php echo $denomination["dennama"]; ?>
                </option>
                <?php endforeach; ?>
            </select>
        </div>
        <div>
            ...
            <input type="text" id="unitnamastu" name="unitnamastu" value="<?php echo $stuff["stuunitnama"]; ?>" required readonly>
        </div>
        <div>
            <label for="stokstu">Stok : </label>
            <input type="text" id="stokstu" name="stokstu" value="<?php echo $stuff["stustok"]; ?>" required>
        </div>
        <div>
            <label for="keteranganstu">Keterangan : </label>
            <input type="text" id="keteranganstu" name="keteranganstu" value="<?php echo $stuff["stuketerangan"]; ?>" required>
        </div>
        <div>
