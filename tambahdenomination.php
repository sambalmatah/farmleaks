...
<body>
    ...
    <form action="" method="post">
        <div>
            ...
            <input type="text" id="kodeden" name="kodeden" placeholder="masukan kode...">
        </div>
        <div>
            <label for="namaden">Nama : </label>
            <input type="text" id="namaden" name="namaden" placeholder="masukan nama...">
        </div>
        <div>
            <label for="keteranganden">Keterangan : </label>
            <input type="text" id="keteranganden" name="keteranganden" placeholder="masukan keterangan...">
        </div>
        <div>
